...
<div class="grid w-full space-y-5">
    <div class="kt-card">
        ...
        <div id="blok_table" class="kt-card-table" data-kt-datatable="true" data-kt-datatable-page-size="10" data-kt-datatable-state-save="true" data-kt-datatable-state-namespace="blok">
