...
@section('title', 'Detail Pemberian Kimia/Antibiotik')
@section('page-title', 'Detail Pemberian Kimia/Antibiotik')
@section('page-description', 'Detail data Pemberian Kimia/Antibiotik')

@section('content')
<div class="grid w-full space-y-5">
    <div class="kt-card">
        <div class="kt-card-header min-h-14">
            <h3 class="kt-card-title">Detail Pemberian Kimia/Antibiotik</h3>
            <a href="{{ route('pemberian-kimia.index') }}" class="kt-btn kt-btn-sm kt-btn-outline">
