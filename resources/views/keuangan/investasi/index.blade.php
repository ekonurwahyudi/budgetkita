                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <span class="inline-flex gap-2.5">
                                    ...
                                    <button type="button" class="kt-btn kt-btn-destructive kt-btn-sm kt-btn-icon" title="Reject" onclick="openRejectModal('{{ route('investasi.reject', $item) }}', '{{ e($item->nomor_transaksi) }}')"><i class="ki-filled ki-cross"></i></button>
                                    @endif
