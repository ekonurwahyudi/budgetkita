    ...
    <div class="kt-card">
        <div class="kt-card-header min-h-16">
            ...
            <a href="{{ route('pemberian-pakan.create') }}" class="kt-btn kt-btn-primary">
                <i class="ki-filled ki-plus-squared"></i> Tambah Pemberian Pakan
            </a>
            @endcan
        </div>
                ...
                <table class="kt-table" data-kt-datatable-table="true">
                    <thead>
                        <tr>
                            ...
                            <th data-kt-datatable-column="item"><span class="kt-table-col"><span class="kt-table-col-label">Item Pakan</span><span class="kt-table-col-sort"></span></span></th>
