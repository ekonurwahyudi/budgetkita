...
// Set default datetime to now + auto-select kategori pakan
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-select first kategori (pakan) and filter items
    var katSel = document.getElementById('kategori_id');
    if (katSel && katSel.options.length > 1) {
        katSel.selectedIndex = 1; // Select first real option (skip placeholder)
        filterItem();
    }
});
