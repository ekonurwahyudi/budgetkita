...
class Panen extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'harga_jual', 'sisa_bayar', 'nominal_dibayar', 'hutang_piutang_id',
        'total_penjualan', 'pembeli',
    ...
    {
        return ['tgl_panen' => 'date', 'total_penjualan' => 'decimal:2', 'harga_jual' => 'decimal:2', 'sisa_bayar' => 'decimal:2', 'nominal_dibayar' => 'decimal:2'];
    }
