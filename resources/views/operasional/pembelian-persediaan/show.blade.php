    ...
    <div class="kt-card">
        <div class="kt-card-header min-h-14">
            ...
            <div class="flex items-center gap-2">
                ...
                <form method="POST" action="{{ route('pembelian-persediaan.reject', $pembelianPersediaan) }}" class="inline" onsubmit="return confirm('Yakin reject?')">@csrf<button type="submit" class="kt-btn kt-btn-destructive kt-btn-sm"><i class="ki-filled ki-cross"></i> Reject</button></form>
                @endif
